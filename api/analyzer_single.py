...
{{
  ...
  "entry_price":         "추천 진입가 — 기술적 지지선·눌림목 기준 구체적 가격 (예: 83,500원, $188.00)",
  "entry_timing":        "진입 타이밍: '즉시 진입' / '눌림목 대기' / '조건부 진입' 중 하나 + 한 줄 이유",
  "entry_strategy_type": "해당 종목에 적합한 분할 전략 유형: '물타기' 또는 '불타기'. 가치주·배당주·중장기는 물타기, 성장주·모멘텀·단기는 불타기가 일반적",
  "entry_strategy":      "선택한 전략 유형에 맞는 2~3단계 분할 매수 계획. 물타기 예시: '1차 83,500원 50% → 2차(하락 시) 80,000원 30% → 3차(추가 하락 시) 76,000원 20%'. 불타기 예시: '1차 83,500원 40% → 2차(상승 확인) 87,000원 40% → 3차(추세 확립) 91,000원 20%'. 관망·매도면 '해당 없음'",
